			...
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
					...
					if (nCapturado == (nTabla*i)){
						nCalif++;
						sValorCapturado=document.getElementById("txtResultado"+i).style="border:6px solid green; background-color:green;";
					} else {
						sValorCapturado=document.getElementById("txtResultado"+i).style="border:6px solid red; background-color:red;";
					}
				}
			}
		}
